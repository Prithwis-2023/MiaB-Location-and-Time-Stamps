...
ax.set_xlabel('X-Axis', c='white')
ax.set_ylabel('Y-Axis', c='white')
ax.set_zlabel('Z-Axis', c='white')

# plot
ax.plot(x_galc, y_galc, z_galc, c='white', label=r'Sun to Gal. Center')
ax.plot(x_tuc, y_tuc, z_tuc, c='white', label=r'Sun to 47 Tucanae')
ax.plot(x_5139, y_5139, z_5139,c='white', label=r'Sun to NGC 5139')
ax.plot(x_6441, y_6441, z_6441, c='yellow', label=r'Sun to NGC 6441')
plt.legend()
plt.show()